...
La base de données `Gymnase2000` contient les informations d'e sportifs, de gymnases et de séances de sport'un club de sport. Elle contient les tables suivantes (au format SAS ici) :
