...
Ainsi, le tableau devient [celui-ci](_specifique/prog-stat-r-tp7-etape7.html).

Et si nous souhaitions avoir des graphiques prenant toute la page en bas, il faudrait faire deux étapes :
