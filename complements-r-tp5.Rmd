...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            numericInput(inputId = "numeric", label = "Saisie d'un nombre", 
             value = 2, min = 0, max = 5),
            sliderInput(inputId = "slider", label = "Choix d'une valeur", 
                        value = 2, min = 0, max = 5),
            checkboxInput(inputId = "check", label = "checkboxInput", value = FALSE),
            textInput(inputId = "texte", label = "Saisie d'un texte court", 
                      value = "texte"),
