...
```{r}
rep4 = data.frame(
    Voies = unique(unlist(lapply(CIS$VoiesAdm, strsplit, ";"))),
    NbMedicaments = 0
)
for (v in CIS$VoiesAdm) {
    rep4$NbMedicaments = rep4$NbMedicaments + rep4$Voies %in% unlist(strsplit(v, ";"))
}
