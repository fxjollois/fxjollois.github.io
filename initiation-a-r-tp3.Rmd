...
1. Créer un nouveau `data.frame` avec uniquement les individus ayant strictement moins de 60 ans
2. Créer maintenant, à partir du précédent, deux `data.frames` (en supprimant l'information sur le sexe) : 
    - un pour les hommes
