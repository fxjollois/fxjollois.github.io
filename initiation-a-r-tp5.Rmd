...
a = c(5, 1, 4, 3)
# Afficahge de celui-ci
a
# Tri de ce vecteur (ordre par défaut = décroissant)
sort(a)
...
for (f in liste) {
    n = sub(".txt", "", f)
    t = read.table(paste(rep, f, sep = ""), sep = ";", header = T)
    assign(n, t)
}
```
