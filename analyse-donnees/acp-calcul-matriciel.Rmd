...
L'intérêt de **`R`** réside, entre autres, dans sa possibilité à réaliser des calculs à partir de matrices et/ou de vecteurs. Nous pouvons ainsi décomposer le calcul de l'ACP directement.
