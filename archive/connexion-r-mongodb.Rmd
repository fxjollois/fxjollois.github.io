...
Dans ce document est l'utilisation du package [`mongolite`](https://cran.r-project.org/web/packages/mongolite/vignettes/intro.html) permettant la connection à une base de données [MongoDB](https://www.mongodb.com/fr).
