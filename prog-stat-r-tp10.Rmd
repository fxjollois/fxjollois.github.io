...
Dans un nouveau répertoire créé spécifiquement, vous devez créer les deux fichiers `R` avec le contenu suivant :
...
**A tester** : changer le titre de l'axe des abcisses pour afficher le nom de la variable choisie.
...
On peut ajouter aussi des informations sous forme de tableau. Voici les modifications à faire aux fichiers :
...
**A tester** : passer le tableau dans la partie droite

## A FAIRE

Dans la partie interface, il est possible de créer un système d'onglet permettant d'avoir plusieurs parties dans l'application. Voici la nouvelle partie interface utilisateur. Vous verrez ainsi le fonctionnement des onglets.
